...
const galleryContainer = document.querySelector('.gallery'); // Create gallery.

const createItem = _galleryItems.galleryItems.map(el => `<div class="gallery__list">
...
galleryContainer.insertAdjacentHTML('beforeend', createItem); // Create SimpleLightbox
